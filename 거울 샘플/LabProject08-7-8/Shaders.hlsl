...
cbuffer cbMirrorObjectInfo : register(b3)
{
...
//    if (gnApplyReflection == 0xff00) cColor = float4(0.0f, 1.0f, 0.0f, 0.0f);
...
/*
struct PS_CLEARDEPTH_OUTPUT
{
    float4 color : SV_Target;
    float depth : SV_Depth;
};

PS_CLEARDEPTH_OUTPUT PSClearDepth(VS_CLEARDEPTH_OUTPUT pin)
{
    PS_CLEARDEPTH_OUTPUT output;
    output.color = float4(0.3f, 0.3f, 0.3f, 0.5f);
    output.depth = 1.0f;
