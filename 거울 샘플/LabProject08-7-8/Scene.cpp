...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[0].BaseShaderRegister = 6; //t6~t12: gtxtAlbedoTexture
	...
	pd3dDescriptorRanges[2].BaseShaderRegister = 14; //t14~16: gtxtTerrainTexture
	...
	pd3dRootParameters[3].DescriptorTable.pDescriptorRanges = &(pd3dDescriptorRanges[0]); //t6~t12: gtxtAlbedoTexture
	...
	pd3dRootParameters[5].DescriptorTable.pDescriptorRanges = &(pd3dDescriptorRanges[2]); //t14~16: gtxtTerrainTexture
	pd3dRootParameters[5].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;

	pd3dRootParameters[6].ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV;
	pd3dRootParameters[6].Descriptor.ShaderRegister = 3; //Reflection Matrix
	...
	pd3dRootParameters[7].Constants.ShaderRegister = 5; //Apply Reflection
...
void CScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
	...
	{
		if (m_ppGameObjects[i]) m_ppGameObjects[i]->Animate(0.16f, NULL);
		if (m_ppGameObjects[i]) m_ppGameObjects[i]->UpdateTransform(NULL);
		if (m_ppGameObjects[i]) m_ppGameObjects[i]->Render(pd3dCommandList, pCamera);
	}
