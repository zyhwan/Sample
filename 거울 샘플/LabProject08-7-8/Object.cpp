...
void CGameObject::LoadMaterialsFromFile(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, CGameObject *pParent, FILE *pInFile, CShader* pShader)
{
	...
	for ( ; ; )
	{
		...
		if (!strcmp(pstrToken, "<Material>:"))
		{
			...
			UINT nMeshType = GetMeshType(0/*nMaterial*/);
		}
...
CSkyBox::CSkyBox(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature) : CGameObject(1, 1)
{
	...
	CScene::CreateShaderResourceViews(pd3dDevice, pSkyBoxTexture, 0, 4);
...
CMirror::CMirror(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature) : CGameObject(1, 1)
{
	...
	pMirrorTexture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"Terrain/Lava(Emissive).dds", RESOURCE_TEXTURE2D, 0);
...
CWall::CWall(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature) : CGameObject(1, 1)
{
	...
	pWallTexture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"Terrain/stones.dds", RESOURCE_TEXTURE2D, 0);
