...
CTexturedCubeMesh::CTexturedCubeMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, float fWidth, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	...
	i = 0;
	m_pxmf2TextureCoords0[i++] = XMFLOAT2(0.0f, 0.0f);
	m_pxmf2TextureCoords0[i++] = XMFLOAT2(1.0f, 0.0f);
	m_pxmf2TextureCoords0[i++] = XMFLOAT2(1.0f, 1.0f);

	m_pxmf2TextureCoords0[i++] = XMFLOAT2(0.0f, 0.0f);
	m_pxmf2TextureCoords0[i++] = XMFLOAT2(1.0f, 1.0f);
	m_pxmf2TextureCoords0[i++] = XMFLOAT2(0.0f, 1.0f);
...
void CTexturedCubeMesh::ReleaseUploadBuffers()
{
	CMesh::ReleaseUploadBuffers();
...
void CTexturedCubeMesh::Render(ID3D12GraphicsCommandList* pd3dCommandList, int nSubSet)
{
	pd3dCommandList->IASetPrimitiveTopology(m_d3dPrimitiveTopology);
